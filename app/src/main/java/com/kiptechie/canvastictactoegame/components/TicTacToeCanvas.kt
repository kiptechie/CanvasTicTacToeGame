package com.kiptechie.canvastictactoegame.components
    ...
    Canvas(modifier = Modifier
        ...
        .pointerInput(true) {
            detectTapGestures { offset ->
                ...
                when {
                    offset.x < size.width / 3f && offset.y < size.height / 3f -> {
                        // Top left
                        if (gameState[0][0] == 'E') {
                    ...
                    offset.x in (size.width / 3f)..(2 * size.width / 3f) &&
                    ...
                    offset.x > 2 * size.width / 3f && offset.y < size.height / 3f -> {
                        // Top right
                        if (gameState[2][0] == 'E') {
                    ...
                    offset.x < size.width / 3f && offset.y in (size.height / 3f)..(2 * size.height / 3f) -> {
                        // Middle left
                        if (gameState[0][1] == 'E') {
                    ...
                    offset.x in (size.width / 3f)..(2 * size.width / 3f) &&
                            offset.y in (size.height / 3f)..(2 * size.height / 3f) -> {
                        // Middle middle
                        if (gameState[1][1] == 'E') {
                    ...
                    offset.x > 2 * size.width / 3f && offset.y in (size.height / 3f)..(2 * size.height / 3f) -> {
                        // Middle right
                        if (gameState[2][1] == 'E') {
                    ...
                    offset.x < size.width / 3f && offset.y > 2 * size.height / 3f -> {
                        // Bottom left
                        if (gameState[0][2] == 'E') {
                    ...
                    offset.x in (size.width / 3f)..(2 * size.width / 3f) && offset.y > 2 * size.height / 3f -> {
                        // Bottom middle
                        if (gameState[1][2] == 'E') {
                    ...
                    offset.x > 2 * size.width / 3f && offset.y > 2 * size.height / 3f -> {
                        // Bottom right
                        if (gameState[2][2] == 'E') {
